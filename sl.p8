...
function states.play:init()
	...
	self.zones={}
	add(self.zones,{x1=30,a1=10,x2=50,a2=30})
...
function states.play:draw_zone(z)
		self:draw_point({x=z.x1,a=z.a1},45)
		self:draw_point({x=z.x2,a=z.a1},45)
		self:draw_point({x=z.x2,a=z.a2},45)
		self:draw_point({x=z.x1,a=z.a2},45)
end
...
-- import END
 ...
 -- move held object
	...
	for item in all(self.objects) do
		...
		self.inzone=self:obj_in_zone(item)
	end
	-- object release
...
function states.play:obj_in_zone(o)
	...
	for z in all(self.zones) do
		in_zone=in_zone or (o.x>=z.x1 and o.x<=z.x2 and angular_distance(o,{a=z.a1})>0 and angular_distance(o,{a=z.a2})<0)
	end
	return in_zone
end
...

...

...

